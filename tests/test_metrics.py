...
synthetic data (no network). Covers z-scores, VALUE composite, quality flag,
MTF after-tax return, return-potential, and the sid/slug extraction + financials
/analyst merge into the swept rows."""
